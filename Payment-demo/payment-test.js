...
const sofortApiKey = 'c6490381A6ab0A4b18A9960Af3a9182c40ba'; // Replace with your SOFORT API key
const sofortBaseUrl = 'https://sandbox.apexx.global/atomic/v1/api/payment/hosted'; // Use if different for SOFORT
const sofortApiClient = new ApiClient(sofortBaseUrl, sofortApiKey);
